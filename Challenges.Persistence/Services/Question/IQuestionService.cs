...
public interface IQuestionService
{
    ...
    Task<Domain.Entities.Question.Question?> UpdateAsync(Domain.Entities.Question.Question? question, Domain.Entities.Question.QuestionType questionType);
    ...
    Task AddAnswerAsync(Domain.Entities.Question.Question question, Domain.Entities.Question.QuestionAnswer answer, int order);
    Task AddAnswersAsync(Domain.Entities.Question.Question question, IEnumerable<Domain.Entities.Question.QuestionAnswer> answers);
    Task AddQuestionTypeAsync(Domain.Entities.Question.Question question, Domain.Entities.Question.QuestionType questionType);
    Task AddQuestionTypesAsync(Domain.Entities.Question.Question question, IEnumerable<Domain.Entities.Question.QuestionType> questionTypes);
}