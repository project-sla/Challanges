...
public interface ISurveyService
{
    ...
    Task<List<Domain.Entities.Survey.Survey>> GetAllAsync(int skip, int take, bool includeQuestions = false,
        bool includeTags = false, bool includeGenres = false);

    Task<List<Domain.Entities.Survey.Survey>> GetAllAsync(int skip, int take, string? search,
        bool includeQuestions = false, bool includeTags = false, bool includeGenres = false);
    ...
    Task AddTagAsync(Domain.Entities.Survey.Survey survey, SurveyTag tag);
    Task AddTagsAsync(Domain.Entities.Survey.Survey survey, IEnumerable<Tag> tags);
    Task AddGenreAsync(Domain.Entities.Survey.Survey survey, SurveyGenre genre);
    ...
    Task AddSurveyTypesAsync(Domain.Entities.Survey.Survey survey,
